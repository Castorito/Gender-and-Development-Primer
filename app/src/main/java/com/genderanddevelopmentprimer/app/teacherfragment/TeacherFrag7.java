...
public class TeacherFrag7 extends Fragment {
    int lastPage;
    PDFView pdfView;
    Button quizBtn;
    String pdfFile;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        StorageReference storageRef = storage.getReference().child("/Teacher PDF Files/Teacher Fragment7.pdf");
