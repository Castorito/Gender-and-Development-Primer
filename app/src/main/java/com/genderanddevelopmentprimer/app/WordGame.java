...
public class WordGame extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference question = fStore.collection("gameQuestions").document("questions");
        question.get().addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                DocumentSnapshot document = task.getResult();
                if (document.exists()) {
                    Map<String, Object> map = document.getData();
                    DocumentReference documentReference = fStore.collection("gameQuestions").document("questions");
                    documentReference.addSnapshotListener(this, (value, error) -> {
                        ...
                        DocumentReference answer = fStore.collection("gameQuestions").document("answers");
                        answer.get().addOnCompleteListener(task1 -> {
                            if (task1.isSuccessful()) {
                                DocumentSnapshot documentSnapshot = task1.getResult();
                                if (documentSnapshot.exists()) {
                                    DocumentReference getAnswer = fStore.collection("gameQuestions").document("answers");
                                    getAnswer.addSnapshotListener(this, (value1, error1) -> {
                                        ...
                                        LinearLayout editTextLayout = new LinearLayout(WordGame.this);
                                        ...
                                        EditText answerBox = new EditText(WordGame.this);
                                        ...
                                        Button backspaceButton = new Button(WordGame.this);
                                        ...
                                        LinearLayout row = new LinearLayout(WordGame.this);
                                        ...
                                        for (char c : charList) {
                                            Button button = new Button(WordGame.this);
                                            ...
                                            button.setOnClickListener(v -> {
                                                ...
                                                if (answerBox.getText().toString().equalsIgnoreCase(answerVal)) {
                                                    ...
                                                    Toast.makeText(WordGame.this, "Correct!", Toast.LENGTH_SHORT).show();
                                                    WordGame.this.finish();
                                                    WordGame.this.startActivity(new Intent(WordGame.this.getIntent()));
                                                    WordGame.this.overridePendingTransition(0, 0);
                                                }
                                            });
                                            ...
                                            if (buttonCount == 4) {
                                                ...
                                                row = new LinearLayout(WordGame.this);
                                                row.setLayoutParams(new LinearLayout.LayoutParams(
                                                        LinearLayout.LayoutParams.MATCH_PARENT,
                                                        LinearLayout.LayoutParams.WRAP_CONTENT
                                                ));
                                        ...
                                        if (buttonCount > 0) {
                                            for (int i = buttonCount; i < 4; i++) {
                                                View spacer = new View(WordGame.this);
