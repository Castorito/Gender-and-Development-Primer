...
public class CommonFrag3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.common_frag_3, container, false);
        PDFView pdfView = v.findViewById(R.id.commonfrag3);
        Button quizBtn = v.findViewById(R.id.btn_quiz);

        pdfView.fromAsset("Common Fragment3.pdf")
